          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-slate-800 rounded-lg p-4 mb-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <a href={`https://reddit.com/submit?url=${getShareUrl()}&title=${getShareText()}`} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-orange-600 rounded hover:bg-orange-500 transition-colors" title="Share on Reddit">
