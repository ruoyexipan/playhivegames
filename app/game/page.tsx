          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="bg-slate-800 rounded-lg p-4 mb-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                }} className="w-8 h-8 flex items-center justify-center bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded hover:opacity-90 transition-opacity" title="Share on Instagram">
